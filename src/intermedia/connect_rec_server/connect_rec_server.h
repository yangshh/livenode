...
#define OPERATION_SUCC				(0)  	//操作成功
#define OPERATION_ERR				(-1)	//操作失败
...
//
static int32_t live_rec_server_recv_data(int32_t socket, int32_t recv_socke, int32_t index,int32_t id);
