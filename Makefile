...
#版本
LIVE_VERSION = $(shell git describe --dirty --always)
#LIVE_VERSION = $(shell git tag)
#LIVE_VERSION = 1.0
...
SRC = $(wildcard src/live/*.c) $(wildcard src/msg/*.c) $(wildcard src/reach_share/*.c)\
 $(wildcard src/silverlight/*.c) $(wildcard src/reach_share/xml/*.c) $(wildcard src/test/*.c)\
 $(wildcard src/intermedia/*.c) $(wildcard src/intermedia/connect_rec_server/*.c)\
 $(wildcard src/intermedia/http/*.c) $(wildcard src/reach_share/sysinfo/*.c)\
 $(wildcard src/cfg/*.c)\
 $(wildcard src/log/*.c)
# object文件
OBJS = $(SRC:.c=.o)
...
INCLUDE = -I./src/live -I./src/msg -I./src/reach_share\
 ...
 -I./src/intermedia/http/curl$(BITS) -I./src/reach_share/xml/libxml\
 -I./src/intermedia/connect_rec_server -I./src/intermedia/http\
 -I./src/reach_share/sysinfo -I./src/reach_share/xml\
 -I./src/cfg\
 -I./\
 -I./src/log
# 链接库
